...
image = Image.open(r'images\WhatsApp Image 2023-03-28 at 16.59.59.jpg')
...
if pred == 0:
    ...
    setosa = Image.open('images\WhatsApp Image 2023-03-28 at 16.59.58.jpg')
    st.image(setosa, caption = 'Iris-setosa', width = 400)
elif pred == 1:
    st.success('The Flower is an Iris-versicolor ')
    versicolor = Image.open('images\WhatsApp Image 2023-03-28 at 17.00.00..jpg')
    st.image(versicolor, caption = 'Iris-versicolor', width = 400)
else:
    st.success('The Flower is an Iris-virginica ')
    virginica = Image.open('images\WhatsApp Image 2023-03-28 at 17.00.00.jpg')
